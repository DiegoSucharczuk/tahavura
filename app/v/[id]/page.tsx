      ...
      <main className="min-h-screen bg-gray-50 p-4 sm:p-6">
        <div className="max-w-md mx-auto">
          ...
          <div className="mb-8 text-center">
            ...
            <p className="text-gray-600">לאישור, הזן את 4 הספרות האחרונות של לוחית הרכב</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 sm:p-8">
            <form onSubmit={handleVerification} className="space-y-4">
              ...
              <div className="mb-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                <p className="text-sm text-gray-600 mb-2">לוחית הרכב</p>
              ...
              {/* Input Field */}
              <div>
                <label htmlFor="lastFour" className="block text-sm font-medium text-gray-700 mb-2">
                  4 הספרות האחרונות <span className="text-red-500">*</span>
                </label>
                <input
                  type="text"
                  id="lastFour"
            ...
            <div className="mt-6 p-4 bg-gray-50 rounded-lg text-sm text-gray-600 text-center">
              <p>זה לצורך אישור שלך שאני בעצם המקבל של ההצעה הזו</p>
            </div>
          </div>
        </div>
      </main>
